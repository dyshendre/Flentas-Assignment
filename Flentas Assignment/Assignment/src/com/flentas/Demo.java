...
//        int freeCalls=0;
        ...
        System.out.println("No. of distinct from numbers for a day: " + distinctFromNumbers.size());
        System.out.println("Numbers are: "+distinctFromNumbers);
        System.out.println("-------------------------------------------------------------------------------");
        
        System.out.println("No. of distinct from numbers who used the Free Plan: "+distinctFree.size());
        System.out.println("Numbers are: "+distinctFree);
        System.out.println("-------------------------------------------------------------------------------");
